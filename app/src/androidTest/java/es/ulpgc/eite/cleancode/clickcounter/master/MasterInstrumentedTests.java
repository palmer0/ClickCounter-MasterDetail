...
public class MasterInstrumentedTests extends GreenCoffeeTest {

  @Rule
  public ActivityTestRule activity = new ActivityTestRule(MasterActivity.class);

  public MasterInstrumentedTests(ScenarioConfig scenarioConfig) {
  ...
  @Test
  public void test() {
    start(new MasterInstrumentedSteps());
  }
}
